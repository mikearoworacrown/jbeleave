...
<script src="<?php echo url_for('js/jquery-3.3.1.js?v=') . time();?>"></script>
<script src="<?php echo url_for('js/jquery-ui.js?v=') . time();?>"></script>
<script src="<?php echo url_for('js/main.js?v=') . time();?>"></script>
<script src="<?php echo url_for('js/login.js?v=') . time();?>"></script>
