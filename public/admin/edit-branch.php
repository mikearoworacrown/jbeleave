        ...
        <span class="close">&times;</span>
            ...
            <form class="jbe__editregion" id="jbe__editregion">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control branchedit" name="branchedit" id="branchedit" placeholder="Branch Name" value ="<?php echo $branchInfo[0]['branch']; ?>" required/>
                    <input type="hidden" class="form-control brancheditid" name="brancheditid" id="brancheditid" value ="<?php echo $branchInfo[0]['branch_id']; ?>" required/>
                    <input type="hidden" class="form-control branchregioneditid" name="branchregioneditid" id="branchregioneditid" value ="<?php echo $region_id; ?>" required/>
                </div>
                <div class="form-group">
