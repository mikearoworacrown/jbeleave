...
<section class="jbe__container-fluid jbe__request-form">
    <div class="jbe__container">
        ...
        <form action="" method="post" class="sub-leave-request-form">
            ...
            <button type="submit" class="jbe__updateSubLeave-submit" id="jbe__updateSubLeave-submit">Process Team Leave</button>
        </form>
    </div>
</section>
